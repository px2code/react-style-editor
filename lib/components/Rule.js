  ...
  function Rule() {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderArea", function (payloadProperty) {
      var _this$props = _this.props,
          ...
          enableTick = _this$props.enableTick,
          disableSelectorDisplay = _this$props.disableSelectorDisplay;
      return !disableSelectorDisplay && /*#__PURE__*/_react["default"].createElement("div", null, enableTick && /*#__PURE__*/_react["default"].createElement(_Checkbox["default"], {
        tick: 1
    ...
    _defineProperty(_assertThisInitialized(_this), "onSelectorClick", function (event) {
      ...
      if (_this.props.disableSelectorRename) {
        return;
      }
    ...
    _defineProperty(_assertThisInitialized(_this), "onBraceClick", function (event) {
      ...
      if (_this.props.disableAddNewRule) {
        return;
      }
  ...
  _createClass(Rule, [{
    ...
    function render() {
      ...
      var _this$props2 = this.props,
          ...
          enableTick = _this$props2.enableTick,
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
      ...
      }, enableTick && /*#__PURE__*/_react["default"].createElement(_Checkbox["default"], {
        id: id,
        tick: 1,
        onTick: onTick
      ...
      }, ' {'), !isEditingAfterBegin && !hasSemicolon && kids.every(function (item) {
        return item.type === _COMMON.DECLARATION;
      ...
      }, "click to add..")), /*#__PURE__*/_react["default"].createElement("div", {
        ...
        return /*#__PURE__*/_react["default"].createElement(Component, _extends({}, item, {
          key: item.id,
          disableAddNewRule: _this2.props.disableAddNewRule,
          disableSelectorRename: _this2.props.disableSelectorRename,
