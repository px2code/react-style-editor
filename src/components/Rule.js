...
class Rule extends React.PureComponent {
          ...
          {kids.map((item) => {
            ...
            return (
              <Component
                {...item}
                key={item.id}
                disableAddNewRule={this.props.disableAddNewRule}
                disableSelectorRename={this.props.disableSelectorRename}
  ...
  renderArea = (payloadProperty) => {
    const { id, onEditChange, enableTick, disableSelectorDisplay } = this.props;
    return (
      !disableSelectorDisplay &&
      <div>
  ...
  onSelectorClick = (event) => {
    ...
    if (this.props.disableSelectorRename) {
      return;
    }
